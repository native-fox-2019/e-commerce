...
* **Error Response:**
  ...
  * **Code:** 400 BadRequest <br />
    **Content:** `{
  "message": [
    "Validation notEmpty on ProductId failed",
  ]
}`
...
* **Success Response:**
  ...
  * **Code:** 200 OK<br />
    **Content:** `[
  {
    ...
    "ProductId": 1,
    "quantity": 1,
    "createdAt": "2020-03-26T16:12:54.903Z",
    "updatedAt": "2020-03-26T16:12:54.903Z",
    "Product": {
      "id": 1,
      "name": "product 1",
      "CategoryId": 1,
      ...
      "stock": 16,
      "description": "string",
      "createdAt": "2020-03-26T02:29:26.706Z",
      "updatedAt": "2020-03-26T02:33:50.374Z"
    }
  }
]`
* **Error Response:**
...
* **Success Response:**
  ...
  * **Code:** 200 OK<br />
  ...
  "quantity": 3,
  "createdAt": "2020-03-26T16:12:54.903Z",
  "updatedAt": "2020-03-26T16:15:43.628Z"
}`
...
* **Error Response:**
  ...
  * **Code:** 400 BadRequest <br />
    **Content:** `{
  "message": [
    "Validation notEmpty on quantity failed",
  ]
}`
...
* **Error Response:**
  ...
  * **Code:** 400 BadRequest <br />
    **Content:** `{
  "message": [
    "Validation min on quantity failed",
  ]
}`
