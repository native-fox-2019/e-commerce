    ...
    <div class="product-detail">
        <div class="container">
            ...
            <div class="action">
                ...
                <div class="add-cart" v-on:click="toggleAddCart">+</div>
            ...
            if (this.qty > 0) {
                if (this.qty <= this.product_temp.stock) {
                    ...
                    this.$store.dispatch("errorHandler", {
                        data: {
                            message:
                                "Can't buy a product that exceeds its stock"
                        }
                    });
                }
            } else {
                this.$store.dispatch("errorHandler", {
                    data: {
                        message:
                            "Are you really want to buy or not? Quantity cannot less than 1"
                    }
                });
            }
        }
