...
<div>
    ...
    <div class="add contsiner mt-5 text-center">
    ...
    <table class="table table-bordered mt-3">
      ...
      <tbody>
        <tr v-for="(product,i) in products" :key="product.id">
          ...
          <td>
            <img :src="product.image_url" alt="airbus" style="width:100%; border-radius:20px;" />
          </td>
          <td>
            <button type="button" class="btn btn-success mt-2" @click="editForm(product)">
              <i class="far fa-edit"></i>
            </button>
            <button type="button" class="btn btn-danger mt-4" @click="deleteData(product.id)">
