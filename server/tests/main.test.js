...
describe('Endpoints carts', () => {
  ...
  it('status code 200 checkout', async () => {
    const res = await request(app)
      .post("/carts/checkout")
      .set("token", tokenUser)
      .send({
        ...
        cart: [
          {
            ...
            ProductId: 2,
            quantity: 1,
            createdAt: "2020-03-26T02:33:45.929Z",
            updatedAt: "2020-03-26T02:33:45.929Z",
            Product: [
              {
                id: 2,
                name: "product 1",
                ...
                updatedAt: "2020-03-26T02:32:46.595Z"
              }
            ]
          }
        ]
